...
public class Menu {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        //System.out.println("case 2 "+userA);
        //System.out.println("case 2 "+userB);
        ...
        User[] users = network.getConnections(network.getUser("Olive"));
        //System.out.println(network.getUser("Olive"));
        ...
        //  Testcase 14
        network.addConnection(network.getUser("Randy"), network.getUser("John"));
        if("".equals(network.toString())) {
